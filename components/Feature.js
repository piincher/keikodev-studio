      ...
      <div className="grid grid-flow-row sm:grid-flow-col grid-cols-1 sm:grid-cols-2 gap-8 py-8 my-12">
        ...
        <div className="flex flex-col items-end justify-center ml-auto w-full lg:w-9/12">
          <h3 className="text-3xl lg:text-4xl font-medium leading-relaxed text-black-600">
            Nous créons différents types de sites Web
          </h3>
          {/* <p className="my-2 text-black-500">
            You can explore the features that we provide with fun and have their
            own functions each feature.
          </p> */}
          <ul className="text-black-500 self-start list-inside ml-8 my-10">
            <li className="relative circle-check custom-list">E-COMMERCE</li>
            <li className="relative circle-check custom-list">LANDING PAGE</li>
